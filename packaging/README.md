...
Release `0.5.1` is public and supports anonymous pulls. The installer pins the
...
```sh
gh workflow run publish-images.yml --repo tengso/triflection-team-builder -f version=0.5.2
```
